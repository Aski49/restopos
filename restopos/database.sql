...
-- ─── MENU ITEM RECIPES (links a menu item to the inventory items it consumes) ──
...
-- ─── STOCK USAGE (automatic deduction log — what went OUT and why) ─────
