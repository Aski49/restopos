          ...
          <td>
            <div style="display:flex;gap:5px">
              <button class="btn btn-sm btn-outline"
                ...
                data-method="<?=htmlspecialchars($e['payment_method'],ENT_QUOTES)?>"
                data-supplier="<?=htmlspecialchars($e['supplier']??'',ENT_QUOTES)?>"
                data-notes="<?=htmlspecialchars($e['notes']??'',ENT_QUOTES)?>"
                onclick="openExpEdit(this)">
                ✏
              </button>
...
<script>
function openExpEdit(btn) {
  document.getElementById('editExpId').value       = btn.dataset.id;
  document.getElementById('editExpDate').value     = btn.dataset.date;
  document.getElementById('editExpCat').value      = btn.dataset.cat;
  document.getElementById('editExpDesc').value     = btn.dataset.desc;
  document.getElementById('editExpAmt').value      = btn.dataset.amount;
  document.getElementById('editExpMethod').value   = btn.dataset.method;
  document.getElementById('editExpSupplier').value = btn.dataset.supplier || '';
