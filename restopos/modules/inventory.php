          ...
          <td>
            <div style="display:flex;gap:5px;flex-wrap:wrap">
              ...
              <button class="btn btn-sm btn-outline"
                onclick='openEditItem(<?=json_encode(["id"=>$i["id"],"name"=>$i["name"],"category_id"=>$i["category_id"],"unit"=>$i["unit"],"qty"=>$i["qty"],"min_qty"=>$i["min_qty"],"unit_cost"=>$i["unit_cost"]])?>)'>✏</button>
...
function openEditItem(item) {
  ...
  document.getElementById('itemMinQty').value    = item.min_qty;
