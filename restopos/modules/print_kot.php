...
<style>
  * { box-sizing:border-box; margin:0; padding:0; }
  body { font-family:'Courier New',monospace; font-size:13px; background:#fff; color:#000; padding:10px; max-width:300px; margin:auto; }
  ...
  @media print { .no-print { display:none; } body{ max-width:80mm; } }
</style>
</head>
<body>
