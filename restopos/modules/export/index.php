...
// Cashier cannot export Payroll or Attendance reports
if (reportTabBlocked($report)) {
    http_response_code(403);
    die('Access denied: your role cannot export this report.');
}
...
<div class="section">
  ...
  <table>
    ...
    foreach($rows as $r):
      $otPay = round(100*$r['overtime_hours'],2);
    ?>
    <tr>
