...
define('ROLE_PAGES', [
    'kitchen' => ['kds'],
    'cashier' => ['dashboard','pos','bills','sales','inventory','expenses','debtors','reports','reservations','kds'],
    'manager' => ['dashboard','pos','bills','sales','inventory','expenses','debtors',
                  'payroll','banking','menu','promotions','employees','reports','reservations','activity_log','kds'],
    'admin'   => ['dashboard','pos','bills','sales','inventory','expenses','debtors',
                  'payroll','banking','menu','promotions','employees','reports','settings',
                  'reservations','activity_log','kds'],
]);

// Reports tabs restricted for cashier — they should NOT see Payroll or Attendance data
